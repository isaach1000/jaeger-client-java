...
public class JaegerSpanContextTest {
  ...
  public void testContextFromString() throws Exception {
    JaegerSpanContext context =
        TextMapCodec.contextFromString("ff:dd:cc:4", new JaegerObjectFactory());
  ...
  public void testToStringFormatsPositiveFields() {
    ...
    JaegerSpanContext contextFromStr =
        TextMapCodec.contextFromString(context.contextAsString(), new JaegerObjectFactory());
